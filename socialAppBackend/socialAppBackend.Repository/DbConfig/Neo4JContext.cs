...
namespace socialAppBackend.Repository.DbConfig
{
    public class Neo4JContext : INeo4jDataAccess
    {
        private IAsyncSession _session;

        private ILogger<Neo4JContext> _logger;
        ...
        /// </summary>
        public Neo4JContext(IDriver driver, ILogger<Neo4JContext> logger, IOptions<ApplicationSettings> appSettingsOptions)
        {
            _logger = logger;
